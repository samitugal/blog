...
*Biyolojik öğrenme ile yapay öğrenmenin kesişimi.*
...
![Sternberg'in üçlü zeka modeli: bilim insanı, sanatçı, esnaf](/images/how-brain-learns/sternberg.png)
*Analitik, yaratıcı, pratik; üçü birbirinin yerine geçmez.*
...
![Çaylak ve deneyimli sürücü karşılaştırması, 8-bit](/images/how-brain-learns/system1-system2-driving.png)
*Aynı sürücü, aynı yol; fark Sistem 2'den Sistem 1'e geçen yıllarda.*
...
![Hipokampüsten kortekse veri aktarımı, REM uykusu](/images/how-brain-learns/hippocampus-cortex.png)
*Geçici tampon → kalıcı ağ. Aktarım uyku sırasında oluyor.*
...
Bugünlerde bu konuya biraz daha fazla önem vermeye başladım. Sonuçta unutuyorsak öğrenmenin ne anlamı var? O yüzden Peter C. Brown'un *[Aklında Kalsın](https://www.amazon.com.tr/Make-Stick-Science-Successful-Learning/dp/0674729013)* kitabını okudum; buradaki çoğu bilgi bu kitaptan geliyor. Bir kitap okurken Anki kartları hazırlamak cidden zor iş, ama bizler yazılımcıyız ve otomasyon işimizin bir parçası. LLM'ler bu tarz işleri kolayca otomatize ediyor.
...
![Kapısı kilitli kütüphane önünde robot, 8-bit](/images/how-brain-learns/frozen-library.png)
*Kapısı kilitli, içi dolu bir kütüphane.*
